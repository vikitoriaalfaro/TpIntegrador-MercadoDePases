...
CREATE TABLE `rumor` (
  ...
  CONSTRAINT `fk_rumor_Usuario1` FOREIGN KEY (`usuario_id_usuario`) REFERENCES `usuario` (`id_usuario`)
...
INSERT INTO `rumor` VALUES (1,25,27,28,1,'POR_DEFINIR',12,'2025-10-13'),(15,19,26,32,1,'CORRECTO',10,'2025-10-11'),(16,3,8,24,3,'POR_DEFINIR',1,NULL),(17,4,26,27,4,'POR_DEFINIR',2,NULL),(18,5,6,4,5,'POR_DEFINIR',0,NULL),(19,6,9,7,6,'POR_DEFINIR',0,NULL),(20,7,5,8,7,'POR_DEFINIR',0,NULL),(21,8,1,2,8,'POR_DEFINIR',0,NULL),(22,9,2,3,9,'POR_DEFINIR',0,NULL),(23,10,1,4,10,'POR_DEFINIR',0,NULL),(24,14,24,25,24,'CORRECTO',0,NULL);
