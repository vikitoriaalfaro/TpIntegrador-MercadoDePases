...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `despuesDeCrearUsuario` AFTER INSERT ON `usuario` FOR EACH ROW begin
update usuario set puntos=0 where id_usuario=new.id_usuario;
end */;;
DELIMITER ;
